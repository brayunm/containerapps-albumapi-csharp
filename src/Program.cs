...
record Album(int Id, string Title, string Artist, double Price, string Image_url)
{
     public static List<Album> GetAll(){
         var albums = new List<Album>(){
            ...
            new Album(2, "Seven Revision Army", "The Blue-Green Stripes", 11.99, "https://aka.ms/albums-containerappslogo"),
            new Album(3, "Scale It Up", "KEDA Club", 11.99, "https://aka.ms/albums-kedalogo"),
